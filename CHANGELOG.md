...
- Upgrades OpenCode CARE reviewer, specialist, and challenger prompts to v2 while retaining fixed exact CARE-v1 snapshots. OpenCode current is CARE v2 with Manager58; OpenCode immediate predecessor is CARE-v1 with Manager58; OpenCode next predecessor is CARE-v1 with Manager57; OpenCode v56 is deeper. Codex current Manager17, immediate Manager16, and deeper Manager15/v14 identities remain separate.
