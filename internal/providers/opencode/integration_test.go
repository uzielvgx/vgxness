...
func TestIntegration_BridgeToolRunsWithNodeAndBunWhenAvailable(t *testing.T) {
	...
	read := `{"protocolVersion":"1","ok":true,"bridge":"healthy","provider":"opencode","status":"reading","read":{"path":"go.mod","content":"module example","sha256":"sha256-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","truncated":false}}`
