...
func TestCAREDocumentationContract(t *testing.T) {
	...
	themes := map[string][]string{
		...
		"docs/opencode-integration.md":  {"16 managed artifacts", "13 agents", "manager v54", "verifier v7", "three CARE v1 roles", "six SDD roles"},
		"docs/codex-integration.md":     {"12 delegated profiles", "Manager v14", "OpenCode v54 parity", "care-reviewer", "care-specialist", "care-challenger"},
		"docs/opencode-setup-wizard.md": {"16 OpenCode-managed artifacts", "13 agents", "manager v54", "Runtime evidence is observed on macOS only"},
		"docs/go-implementation.md":     {"16 managed artifacts", "manager v54", "manager v14", "12 delegated profiles", "not a Go provider runtime or a new schema/transport surface"},
