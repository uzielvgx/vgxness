...
func TestCAREDocumentationContract(t *testing.T) {
	...
	themes := map[string][]string{
		...
		"docs/opencode-integration.md":  {"16 managed artifacts", "13 agents", "manager v57", "manager-v56 package is the immediate predecessor", "manager-v55/verifier-v6", "verifier v7", "three CARE v1 roles", "six SDD roles"},
		"docs/codex-integration.md":     {"12 delegated profiles", "Manager v17", "parity OpenCode manager v57", "care-reviewer", "care-specialist", "care-challenger"},
		"docs/opencode-setup-wizard.md": {"16 OpenCode-managed artifacts", "13 agents", "manager v57", "Runtime evidence is observed on macOS only"},
