...
func TestCAREDocumentationContract(t *testing.T) {
	...
	themes := map[string][]string{
		...
		"docs/opencode-integration.md":  {"16 managed artifacts", "13 agents", "Manager59", "immediate predecessor is exact CARE-v2 Manager58", "CARE-v1 Manager58 and CARE-v1 Manager57", "OpenCode v56/verifier-v6", "verifier v7", "three CARE v2 roles", "six SDD roles"},
		...
		"docs/opencode-setup-wizard.md": {"16 OpenCode-managed artifacts", "13 agents", "Manager59", "OpenCode immediate CARE-v2/Manager58", "Runtime evidence is observed on macOS only"},
