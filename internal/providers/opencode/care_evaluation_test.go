...
func TestCAREDocumentationContract(t *testing.T) {
	...
	themes := map[string][]string{
		...
		"docs/opencode-integration.md":  {"16 managed artifacts", "13 agents", "manager v58", "manager-v57 package is the immediate predecessor", "manager-v56/verifier-v6", "verifier v7", "three CARE v1 roles", "six SDD roles"},
		...
		"docs/opencode-setup-wizard.md": {"16 OpenCode-managed artifacts", "13 agents", "manager v58", "Runtime evidence is observed on macOS only"},
