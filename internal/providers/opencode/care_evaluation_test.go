...
func TestCAREDocumentationContract(t *testing.T) {
	...
	themes := map[string][]string{
		...
		"docs/opencode-integration.md":  {"17 managed artifacts", "13 agents", "plugins/vgxness-memory-lifecycle.ts", "no `opencode.json` plugin entry", "Manager60", "immediate predecessor is exact Manager59", "CARE-v2 Manager58", "CARE-v1 Manager58/Manager57", "Execution Brief", "OpenCode v56/verifier-v6", "verifier v7", "three CARE v2 roles", "six SDD roles"},
		"docs/codex-integration.md":     {"12 delegated profiles", "Manager v19", "parity OpenCode manager v60", "Execution Brief", "care-reviewer", "care-specialist", "care-challenger"},
		"docs/opencode-setup-wizard.md": {"17 managed artifacts", "plugins/vgxness-memory-lifecycle.ts", "no `opencode.json` plugin entry", "13 agents", "Manager60", "OpenCode immediate Manager59", "Execution Brief", "Runtime evidence is observed on macOS only"},
		"docs/go-implementation.md":     {"17 managed artifacts", "plugins/vgxness-memory-lifecycle.ts", "no `opencode.json` plugin entry", "OpenCode current CARE-v2 Manager60 roles", "immediate Manager59 predecessor", "CARE-v2/Manager58", "CARE-v1/Manager58/Manager57", "OpenCode v56/verifier-v6 deeper lifecycle identity", "Codex current Manager19", "Codex Manager18 as immediate predecessor", "Manager17, Manager16 and deeper Manager15/v14", "12 delegated profiles", "Execution Brief", "not a Go provider runtime or a new schema/transport surface"},
