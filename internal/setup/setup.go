...
func OpenCodeSteps() []Step {
	return []Step{
		...
		{Number: 3, Title: "Instalar el manager y agentes nativos", Explanation: "Crearé un vgxness-manager, una sustitución administrada y de solo lectura para Explore, cinco revisores de solo lectura y seis agentes SDD especializados enlazados al plan de modelos activo. General integrado no se sobrescribe. El manager conserva la autoridad exclusiva sobre estado y fases.", Mutates: true},
