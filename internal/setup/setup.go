...
func OpenCodeSteps() []Step {
	return []Step{
		...
		{Number: 4, Title: "Instalar los artefactos del proveedor OpenCode", Explanation: "Instalaré los 7 agentes enlazados al plan de modelos activo: vgxness-manager con workspace de solo lectura y operaciones Git aprobadas por el usuario, sustituciones administradas para Explore y general, un verificador independiente, tres perfiles CARE de revisión de solo lectura. El manager conserva la responsabilidad sobre alcance y entrega; general es el único escritor ordinario de código fuente.", Mutates: true},
		{Number: 5, Title: "Publicar las skills globales portables", Explanation: "Después del retiro seguro, instalaré o verificaré globalmente el catálogo de 18 skills y 46 archivos: skills-creator, git-delivery, cross-platform, installer-lifecycle, agent-evaluation, ci-triage, security-boundary, documentation-strategy, product-requirements, software-architecture-docs, user-documentation, api-documentation, quality-test-documentation, operations-runbooks, governance-compliance-docs, release-lifecycle-docs, end-to-end-testing, memory-sync, en el directorio compartido de skills. Estas skills no pertenecen a OpenCode y su desinstalación no las elimina.", Mutates: true},
