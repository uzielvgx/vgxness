...
func OpenCodeSteps() []Step {
	return []Step{
		...
		{Number: 3, Title: "Instalar manager y subagentes nativos", Explanation: "Crearé vgxness-manager y los perfiles ocultos vgxness-navigator, vgxness-explorer, vgxness-implementer y vgxness-reviewer. Navigator solo propone tareas; VGXNESS valida el plan, decide las waves y crea las sesiones hijas. Ningún subagente puede volver a delegar.", Mutates: true},
		{Number: 4, Title: "Instalar el plugin y bridge acotado", Explanation: "Crearé vgxness_status, vgxness_dispatch y vgxness_orchestrate en un plugin administrado. Cada ejecución usa tickets y sesiones hijas nativas de OpenCode, y VGXNESS acepta el resultado antes de publicar evidencia; no inicia un segundo proceso OpenCode. El modelo queda fijado fuera de los argumentos controlados por el agente.", Mutates: true},
