...
func OpenCodeSteps() []Step {
	return []Step{
		...
		{Number: 4, Title: "Instalar almacenamiento y plan VGXNESS", Explanation: "Instalaré el plugin de almacenamiento sin ejecución, un manifiesto no secreto que enlaza low/medium/high y un overlay opencode.jsonc dedicado que selecciona vgxness-manager como agente predeterminado sin modificar opencode.json. El plugin no enruta modelos.", Mutates: true},
