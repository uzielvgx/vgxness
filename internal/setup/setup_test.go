...
func TestPlanExplainsEveryStepAndDoesNotMutate(t *testing.T) {
	...
	if !strings.Contains(plan.Steps[3].Title, "artefactos del proveedor") || !strings.Contains(plan.Steps[3].Explanation, "15 agentes enlazados al plan de modelos") || !strings.Contains(plan.Steps[4].Explanation, "17 skills y 41 archivos") || !strings.Contains(plan.Steps[4].Explanation, "skills-creator, stacked-pr, cross-platform, installer-lifecycle, agent-evaluation, ci-triage, security-boundary, documentation-strategy, product-requirements, software-architecture-docs, user-documentation, api-documentation, quality-test-documentation, operations-runbooks, governance-compliance-docs, release-lifecycle-docs y end-to-end-testing") || !strings.Contains(plan.Steps[4].Explanation, "no pertenecen a OpenCode") {
