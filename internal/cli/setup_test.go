...
func setupPlanFixture(ready bool) setupflow.Plan {
	return setupflow.Plan{
		...
		Skills:      skills.Result{State: skills.StateAbsent, Path: "/shared/skills", FileCount: 18},
