...
func assertOpenCodeDocumentationContract(t *testing.T) {
	...
	documents := map[string][]string{
		...
		"../../docs/go-implementation.md":     {"16 managed artifacts", "Manager v58", "manager-v57 immediate predecessor", "manager-v56/verifier-v6 deeper lifecycle identity", "manager v17", "manager v16 artifact validated as its immediate historical predecessor", "manager v15 retained as a deeper lifecycle identity", "12 delegated profiles", "schema v19", "not a Go provider runtime or a new schema/transport surface", "`vgxness mcp --full`", "no plugin is installed", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes are drift"},
		"../../docs/opencode-setup-wizard.md": {"16 OpenCode-managed artifacts", "manager v58", "`general` v10", "verifier v7", "three CARE v1 roles", "six SDD roles", "not a runtime broker", "`vgxness mcp --full`", "five memory and 13 SDD tools", "no plugin is installed", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/codex-integration.md":     {"current generated manager is v17", "parity OpenCode manager v58", "exact v16 artifact is the immediate predecessor", "v15 and older packages retained for lifecycle recognition only", "zero execution tools", "at most one autonomous `memory_save`", "rather than Codex runtime enforcement"},
