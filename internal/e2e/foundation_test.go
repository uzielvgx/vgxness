...
func TestFoundationProductContract(t *testing.T) {
	...
	if err != nil || len(migrations) != 20 {
		t.Fatalf("foundation must retain exactly twenty migrations: %v %v", migrations, err)
	}
