...
func assertOpenCodeDocumentationContract(t *testing.T) {
	...
	documents := map[string][]string{
		...
		"../../docs/product-blueprint.md":     {"19 provider artifacts", "22 files", "agent-evaluation", "ci-triage", "security-boundary", "OpenCode uninstall never owns"},
		"../../docs/product-blueprint.es.md":  {"19 artefactos", "22 archivos", "agent-evaluation", "ci-triage", "security-boundary", "desinstalación de OpenCode"},
		"../../docs/go-implementation.md":     {"19 exact managed artifacts", "22-file", "agent-evaluation", "ci-triage", "security-boundary", "does not remove global skills"},
