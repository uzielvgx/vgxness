...
func assertOpenCodeDocumentationContract(t *testing.T) {
	...
	documents := map[string][]string{
		...
		"../../docs/opencode-setup-wizard.md": {"16 OpenCode-managed artifacts", "manager v56", "`general` v10", "verifier v7", "three CARE v1 roles", "six SDD roles", "not a runtime broker", "`vgxness mcp --full`", "five memory and 13 SDD tools", "no plugin is installed", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/codex-integration.md":     {"current generated manager is v16", "parity OpenCode manager v56", "exact v15 artifact is the immediate predecessor", "v14 and older packages retained for lifecycle recognition only", "zero execution tools", "at most one autonomous `memory_save`", "rather than Codex runtime enforcement"},
