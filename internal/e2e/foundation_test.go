...
func TestUnreleasedChangelogManagedArtifactVersions(t *testing.T) {
	...
	for _, fact := range []struct {
		...
		{`\bOpenCode manager v[0-9]+\b`, "OpenCode manager v48"},
		{`\bCodex manager v[0-9]+\b`, "Codex manager v8"},
...
func assertOpenCodeDocumentationContract(t *testing.T) {
	...
	documents := map[string][]string{
		...
		"../../docs/opencode-integration.md":  {"18 managed artifacts", "15 agents", "manager v48", "`general` v6", "verifier v4", "reviewers v3", "`vgxness mcp --full`", "five memory tools and 13 SDD tools", "There is no installed plugin", "no caller identity", "automatic memory injection", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/product-blueprint.md":     {"18 provider artifacts", "Manager v48", "`general` v6", "verifier v4", "MCP-only", "General v6 and verifier v4", "Review profiles v3", "`vgxness mcp --full`", "five memory tools and 13 SDD tools", "No plugin is installed", "no caller identity", "No installed plugin", "automatic memory injection", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/product-blueprint.es.md":  {"18 artefactos", "Manager v48", "General v6 y verificador v4", "reviewer v3", "`vgxness mcp --full`", "cinco herramientas de memoria y 13 de SDD", "No se instala plugin", "no tiene identidad del llamador", "No hay plugin instalado", "inyección automática de memoria", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modificados, malformados, extranjeros, desconocidos o más nuevos bloquean sin eliminación"},
		"../../docs/go-implementation.md":     {"18 exact managed artifacts", "Manager v48", "Codex manager v8", "`general` v6, verifier v4, and reviewers v3", "`vgxness mcp --full`", "no installed plugin", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/opencode-setup-wizard.md": {"18 OpenCode-managed artifacts", "manager v48", "`general` v6, verifier v4, and five reviewers v3", "`vgxness mcp --full`", "five memory and 13 SDD tools", "no plugin is installed", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
