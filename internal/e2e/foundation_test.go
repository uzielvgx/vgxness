...
func TestFoundationProductContract(t *testing.T) {
	...
	if err != nil || len(migrations) != 19 {
		t.Fatalf("foundation must retain exactly nineteen migrations: %v %v", migrations, err)
	}
...
func assertOpenCodeDocumentationContract(t *testing.T) {
	...
	documents := map[string][]string{
		"../../README.md":                     {"16 managed artifacts", "13 model-bound agents", "`vgxness-manager` v58", "Codex Manager17", "three CARE v2 profiles", "OpenCode current CARE v2 with Manager58 has immediate CARE-v1/Manager58 and next CARE-v1/Manager57 predecessors; OpenCode v56 is deeper.", "Codex current Manager17 has immediate Manager16 and deeper Manager15/v14 identities", "`general` v10", "verifier v7", "zero execution tools", "at most one autonomous save", "not runtime enforcement", "`vgxness mcp --full`", "five memory and 13 SDD tools", "No plugin is installed", "no caller identity", "automatic memory injection", "runtime-security guarantee", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "Modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/opencode-integration.md":  {"16 managed artifacts", "13 agents", "OpenCode current is CARE v2 with Manager58", "OpenCode immediate predecessor is exact CARE-v1 with Manager58", "OpenCode next predecessor is exact CARE-v1 with Manager57", "OpenCode v56/verifier-v6 is deeper", "`general` v10", "verifier v7", "three CARE v2 roles", "six SDD roles", "zero execution tools", "at most one durable", "not runtime enforcement", "`vgxness mcp --full`", "five memory and 13 SDD tools", "There is no installed plugin", "no caller identity", "automatic memory injection", "schema v19", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/product-blueprint.md":     {"16 provider artifacts", "Manager v58", "MCP-only", "zero-execution-tool fast path", "at most one autonomous save", "not runtime enforcement", "`vgxness mcp --full`", "five memory tools and 13 SDD tools", "No plugin is installed", "no caller identity", "No installed plugin", "automatic memory injection", "OpenCode manager v57 and Codex manager v16 artifacts remain recognized historical predecessors", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/product-blueprint.es.md":  {"16 artefactos", "Manager v58", "ruta rápida sin herramientas de ejecución", "como máximo un guardado autónomo", "no enforcement de runtime", "`vgxness mcp --full`", "cinco herramientas de memoria y 13 de SDD", "No se instala plugin", "no tiene identidad del llamador", "No hay plugin instalado", "inyección automática de memoria", "manager v57 de OpenCode y el manager v16 de Codex", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modificados, malformados, extranjeros, desconocidos o más nuevos bloquean sin eliminación"},
		"../../docs/go-implementation.md":     {"16 managed artifacts", "OpenCode current CARE v2 roles with Manager58", "OpenCode immediate CARE-v1/Manager58 predecessor", "OpenCode next CARE-v1/Manager57 predecessor", "OpenCode v56/verifier-v6 deeper lifecycle identity", "Codex current Manager17", "Codex Manager16 as immediate predecessor", "Codex Manager15/v14 as deeper lifecycle identities", "12 delegated profiles", "schema v19", "not a Go provider runtime or a new schema/transport surface", "`vgxness mcp --full`", "no plugin is installed", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes are drift"},
		"../../docs/opencode-setup-wizard.md": {"16 OpenCode-managed artifacts", "Manager58", "OpenCode immediate CARE-v1/Manager58", "OpenCode next CARE-v1/Manager57", "`general` v10", "verifier v7", "three CARE v2 roles", "six SDD roles", "not a runtime broker", "`vgxness mcp --full`", "five memory and 13 SDD tools", "no plugin is installed", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/codex-integration.md":     {"Codex current identity is Manager17", "Codex immediate predecessor is Manager16", "Codex Manager15/v14 are deeper lifecycle identities", "OpenCode current identity is CARE v2 with Manager58", "zero execution tools", "at most one autonomous `memory_save`", "rather than Codex runtime enforcement"},
