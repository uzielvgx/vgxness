...
func TestFoundationProductContract(t *testing.T) {
	...
	if err != nil || len(migrations) != 22 {
		t.Fatalf("foundation must retain exactly twenty-two migrations: %v %v", migrations, err)
	}
