...
func assertOpenCodeDocumentationContract(t *testing.T) {
	...
	documents := map[string][]string{
		"../../README.md":                     {"16 managed artifacts", "13 model-bound agents", "`vgxness-manager` v57", "Codex manager v17", "`general` v10", "verifier v7", "three CARE profiles", "zero execution tools", "at most one autonomous save", "not runtime enforcement", "`vgxness mcp --full`", "five memory and 13 SDD tools", "No plugin is installed", "no caller identity", "automatic memory injection", "runtime-security guarantee", "Exact `vgxness-manager` v56 and Codex manager v16 artifacts are immediate historical predecessors", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "Modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/opencode-integration.md":  {"16 managed artifacts", "13 agents", "manager v57", "manager-v56 package is the immediate predecessor", "manager-v55/verifier-v6", "`general` v10", "verifier v7", "three CARE v1 roles", "six SDD roles", "zero execution tools", "at most one durable", "not runtime enforcement", "`vgxness mcp --full`", "five memory and 13 SDD tools", "There is no installed plugin", "no caller identity", "automatic memory injection", "schema v19", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/product-blueprint.md":     {"16 provider artifacts", "Manager v57", "MCP-only", "zero-execution-tool fast path", "at most one autonomous save", "not runtime enforcement", "`vgxness mcp --full`", "five memory tools and 13 SDD tools", "No plugin is installed", "no caller identity", "No installed plugin", "automatic memory injection", "OpenCode manager v56 and Codex manager v16 artifacts remain recognized historical predecessors", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/product-blueprint.es.md":  {"16 artefactos", "Manager v57", "ruta rápida sin herramientas de ejecución", "como máximo un guardado autónomo", "no enforcement de runtime", "`vgxness mcp --full`", "cinco herramientas de memoria y 13 de SDD", "No se instala plugin", "no tiene identidad del llamador", "No hay plugin instalado", "inyección automática de memoria", "manager v56 de OpenCode y el manager v16 de Codex", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modificados, malformados, extranjeros, desconocidos o más nuevos bloquean sin eliminación"},
		"../../docs/go-implementation.md":     {"16 managed artifacts", "Manager v57", "manager-v56 immediate predecessor", "manager-v55/verifier-v6 deeper lifecycle identity", "manager v17", "manager v16 artifact validated as its immediate historical predecessor", "manager v15 retained as a deeper lifecycle identity", "12 delegated profiles", "schema v19", "not a Go provider runtime or a new schema/transport surface", "`vgxness mcp --full`", "no plugin is installed", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes are drift"},
		"../../docs/opencode-setup-wizard.md": {"16 OpenCode-managed artifacts", "manager v57", "`general` v10", "verifier v7", "three CARE v1 roles", "six SDD roles", "not a runtime broker", "`vgxness mcp --full`", "five memory and 13 SDD tools", "no plugin is installed", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/codex-integration.md":     {"current generated manager is v17", "parity OpenCode manager v57", "exact v16 artifact is the immediate predecessor", "v15 and older packages retained for lifecycle recognition only", "zero execution tools", "at most one autonomous `memory_save`", "rather than Codex runtime enforcement"},
