...
func assertOpenCodeDocumentationContract(t *testing.T) {
	...
	documents := map[string][]string{
		"../../README.md":                     {"18 managed artifacts", "15 model-bound agents", "`vgxness-manager` v49", "Codex manager v9", "`general` v6", "verifier v4", "reviewer profiles v3", "zero execution tools", "at most one autonomous save", "not runtime enforcement", "`vgxness mcp --full`", "five memory and 13 SDD tools", "No plugin is installed", "no caller identity", "automatic memory injection", "runtime-security guarantee", "OpenCode manager v48 and Codex manager v8 artifacts remain immediate historical predecessors", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "Modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/opencode-integration.md":  {"18 managed artifacts", "15 agents", "manager v49", "`general` v6", "verifier v4", "reviewers v3", "zero execution tools", "at most one save", "not runtime enforcement", "`vgxness mcp --full`", "five memory tools and 13 SDD tools", "There is no installed plugin", "no caller identity", "automatic memory injection", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		...
		"../../docs/go-implementation.md":     {"18 exact managed artifacts", "Manager v49", "Codex manager v9", "`general` v6, verifier v4, and reviewers v3", "adaptive zero-ceremony fast paths", "prompt instructions rather than a Go runtime broker", "`vgxness mcp --full`", "no installed plugin", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/opencode-setup-wizard.md": {"18 OpenCode-managed artifacts", "manager v49", "`general` v6, verifier v4, and five reviewers v3", "zero-execution-tool fast path", "at most one autonomous memory save", "not a runtime broker", "`vgxness mcp --full`", "five memory and 13 SDD tools", "no plugin is installed", "vgxness.ts", "v1-v10", "vgxness-autonomous-stacked-pr", "v1/v2/v3", "modified, malformed, foreign, unknown, or newer bytes block without removal"},
		"../../docs/codex-integration.md":     {"manager is v9", "exact v8 artifact", "zero execution tools", "at most one autonomous `memory_save`", "not Codex runtime enforcement"},
