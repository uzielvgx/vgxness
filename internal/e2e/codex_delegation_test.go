...
func TestCodexDelegationRuntime(t *testing.T) {
	...
	cases := []struct{ name, prompt, marker string }{
		...
		{"care-reviewer", "Delegate to CARE Reviewer as a fresh specialist task. Do not use a full-history fork. Review frozen candidate with Review Binding candidateDigest test-digest, exact changedPaths [README.md], diffScope README.md, acceptanceCriteria title present; return exactly CARE-REVIEWER-BOUND.", "CARE-REVIEWER-BOUND"},
		{"care-specialist", "Delegate to CARE Specialist as a fresh specialist task. Do not use a full-history fork. Review the assigned CARE domain against frozen candidate with Review Binding candidateDigest test-digest, exact changedPaths [README.md], diffScope README.md, acceptanceCriteria title present; return exactly CARE-SPECIALIST-BOUND.", "CARE-SPECIALIST-BOUND"},
		{"care-challenger", "Delegate to CARE Challenger as a fresh specialist task. Do not use a full-history fork. Challenge supplied typed claim target C-1 against frozen candidate with Review Binding candidateDigest test-digest, exact changedPaths [README.md], diffScope README.md, acceptanceCriteria title present; return exactly CARE-CHALLENGER-BOUND.", "CARE-CHALLENGER-BOUND"},
	}
