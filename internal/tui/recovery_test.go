...
func TestSetupRecoveryTabDefaultsManagedLoadsRealStateAndSelectsSnapshots(t *testing.T) {
	...
	for _, expected := range []string{"CONTROLLED WRITE", "Backup & Recovery", "MANAGED", "/config/opencode", "/backups", "14", "20260729T120000", "2.0 KiB"} {
...
func readyRecoveryBackend() *recordingRecoveryBackend {
	return &recordingRecoveryBackend{
		plan: RecoveryPlan{Mode: RecoveryModeManaged, SourceRoot: "/config/opencode", BackupRoot: "/backups", ArtifactCount: 14, LauncherState: "installed", IntegrationState: "installed", HandshakeOK: true, HandshakeStatus: "healthy", Ready: true},
		list: BackupListResult{Snapshots: []BackupSummary{
			{SnapshotID: "20260729T120000.000000000Z-0123456789abcdef", CreatedAt: "2026-07-29T12:00:00Z", Mode: RecoveryModeManaged, FileCount: 14, TotalBytes: 2048},
		...
		backup:    BackupResult{Mode: RecoveryModeManaged, Snapshot: BackupSummary{SnapshotID: "20260729T120000.000000000Z-0123456789abcdef", Mode: RecoveryModeManaged, FileCount: 14}},
