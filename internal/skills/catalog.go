...
func bundledCatalog() (catalog, error) {
	...
	return catalog{definitions: []skillDefinition{creator, stackedPR, crossPlatform, installerLifecycle, agentEvaluation, ciTriage, securityBoundary, documentationStrategy}}, nil
}
