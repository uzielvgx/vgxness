...
| `internal/orchestration` | Pure routing, CARE, and readiness policy/evidence types consumed by provider renderers; it is not a runtime work executor or authorization enforcer. |
