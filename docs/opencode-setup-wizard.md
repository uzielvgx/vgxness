...
Active global delivery is `git-delivery` v1 through exact `stacked-pr` v3 migration. OpenCode current is CARE-v2 Manager59, immediately CARE-v2 Manager58, then CARE-v1 Manager58 and Manager57; v56 is deeper. It is policy only: no Go/runtime writer, daemon, or durable delivery state.
