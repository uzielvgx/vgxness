...
- manager v41, 14 other model-bound agents, plugin v5, model-plan manifest, default-agent selection, restoration metadata, and the separate global 18-skill catalog;
...
| --- | ---: | --- |
| Manager v41 | 1 | Sole orchestration, lifecycle, Git, and GitHub actor. |
