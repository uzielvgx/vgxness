...
- manager v41, otros 14 agentes ligados a modelos, plugin v5, manifiesto de modelos, selección predeterminada, metadatos de restauración y el catálogo global separado de 18 skills;
...
| --- | ---: | --- |
| Manager v41 | 1 | Única autoridad de orquestación, ciclo, Git y GitHub. |
